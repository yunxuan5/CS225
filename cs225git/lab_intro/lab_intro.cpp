...
PNG watermark(PNG firstImage, PNG secondImage) {
  unsigned maxWidth =(firstImage.width() < secondImage.width())? firstImage.width() : secondImage.width();
  unsigned maxHeight = (firstImage.height() < secondImage.height())? firstImage.height() : secondImage.height();
